...
import { processValueStudy, ProcessingParameters } from '../utils/imageProcessing'
import toast from 'react-hot-toast'
import { useAuth } from '../hooks/useAuth'

export function ValueStudyExperiment() {
    ...
    const runProcessing = async () => {
      ...
      try {
        ...
        const processingResult = await processValueStudy(imageUrl, {
          levels: 5,
          // smoothness will be calculated automatically
        })
          ...
          try {
            await updateResults({
              ...
              results: {
                ...
                parameters: { levels: 5, smoothness: 12 }
              },
              status: 'failed'
            })
          } catch (e) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Value Study</h1>
          <p className="text-gray-600 mt-2">
            Processing image to extract tonal values...
          </p>
        </div>
            ...
            {processing && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  Applying Gaussian blur, posterization, and value extraction...
                </p>
